...
public class AddNewCurrencyRateTests : BaseCurrencyTests
{
    ...
    public void Add_Should_Add_New_Currency_When_There_Is_No_Overlap_Between_New_Close_Interval_TimePeriod_And_New_One(
    ...
    public void
        Add_Should_Not_Add_New_Currency_When_There_Is_Overlap_Between_The_Given_Close_Interval_TimePeriod_And_New_One(
            int? fromDate1, int? toDate1, int? fromDate2, int? toDate2)
    {
        var timePeriod = GetTimePeriod(fromDate1, toDate1, fromDate2, toDate2);
        var currency = _builder
        ...
        {
            //currency.Add(TimePeriod.New(timePeriod.from2, timePeriod.to2), CurrencyConsts.SOME_PRICE);
            currency.Add(new TimePeriodTest(timePeriod.from2, timePeriod.to2), CurrencyConsts.SOME_PRICE);
        });
            ...
            int? fromDate1, int? toDate1, int? fromDate2, int? toDate2, int? fromDate3, int? toDate3)
    {
        ...
        var exception = Assert.Throws<OverlapTimePeriodException>(() =>
        {
            currency.Add( new TimePeriodTest(timePeriod.from3, timePeriod.to3), CurrencyConsts.SOME_PRICE);
        });
